...
function scene:create( event )
	...
	local background = display.newImageRect( sceneGroup, "assets/img/bgHighScores.png", 1376, 800)
	...
	local menuButton = display.newText( sceneGroup, "Back to Main Menu", display.contentCenterX+280, 710, native.systemFont, 44 )
